...
public class JinjaFilterNode extends JinjaNode {
    ...
    /** Prints the filter name and, when present, its raw argument text, e.g. {@code round(2)}. */
    @Override
    public void print(String indent) {
        ...
        fields.add((ind, last) -> TreePrinter.leaf(ind, last, "FilterName", filterName));
        if (hasArguments()) {
            fields.add((ind, last) -> TreePrinter.leaf(ind, last, "Arguments", arguments));
        }
