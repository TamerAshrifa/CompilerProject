...
public class ASTRuleNode extends ASTNode {
    ...
    /**
     * Prints this node's (already-overridden, rule-specific) identity line
     * followed by its wrapped {@link #getChildren() children}, one per
     * generic grammar sub-rule.
     */
    @Override
    public void print(String indent) {
        System.out.println(indent + selfDescription());
        TreePrinter.children(TreePrinter.continuation(indent), true, "Children", children);
    }
}